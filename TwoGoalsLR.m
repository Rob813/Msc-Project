% Grid World with two goals to the right and left of agent
...
trainOpts.StopTrainingCriteria = "AverageReward"; % Can be changed to other things like no. of episodes
